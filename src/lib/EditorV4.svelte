<script lang="ts">
	...
	export let value = '';
	export let editor: Element | null = null;
	export let label = '';
	export let disabled = false;
	export let required = false;
	export let config: ITrixConfig = {};
	export let onChange: ((value: string) => void) | undefined = undefined;
	export let onFileAccept: ((event: Event) => void) | undefined = undefined;
	export let onAttachmentAdd: ((event: Event) => void) | undefined = undefined;
	export let onAttachmentRemove: ((event: Event) => void) | undefined =
		undefined;
	export let onSelectionChange: ((event: Event) => void) | undefined =
		undefined;
	export let onFocus: ((event: Event) => void) | undefined = undefined;
	export let onBlur: ((event: Event) => void) | undefined = undefined;
	export let onPaste: ((event: Event) => void) | undefined = undefined;
	export let onActionInvoke: ((event: Event) => void) | undefined = undefined;

	let Trix: any;

	let _editor: Element | null;
